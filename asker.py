...
_SETUP_KNOWLEDGE = (
    ...
    "Anthropic Managed Agents), Grok bots (xAI SDK), and a custom GPT built "
    "in ChatGPT.\n"
...
_CONNECT_SETUP_EXTRAS = (
    ...
    "- Grok bots (the xai-sdk package): pip install trovis-agents[xai]; same "
    ...
    "tracer provider, names every bot \"xai-sdk\", and exports protobuf, "
